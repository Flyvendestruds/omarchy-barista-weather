...
BarWidget {
  ...
  // Stock wiring: pass the bar facade straight through. The facade's
  // setCenterHoverRevealSuppressed() is a real function; never assign its
  // readonly property (see Panel.qml helper).
